    ...
    >
      <div className={styles.controlPanelContainer}>
        ...
        <div className={styles.NameAndApprovalContainer}>
          <div className={styles.memberName}>會員：<span className={styles.nameTab}>嗶哩叭啦星球</span></div>
...
<div>
<Button style={{ width: 130, height: 34, color: "black", fontSize: 14, marginLeft: 140, marginTop: 70, borderRadius: 10, marginBottom: 60}} color="orange" > 確定</Button>
</div>
      </div>
      </MantineProvider>
  );
