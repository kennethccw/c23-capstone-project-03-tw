...
import { AdoptionApplication, AdoptionResult, approvalOfAdoption, rejectOfAdoption,
    //  approvalOfAdoption 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   <div className={styles.petPaperBigContainer} >
          <Paper shadow="xl" radius="xl" p="xl" className={styles.paperContainer}>
            <img className={styles.petImg} src={`/photos/activities/${props.image}`} alt="" onClick={props.clickHandler}/>
              ...
              <div className={styles.bottomContainer}>
                ...
                <div className={styles.buttonContainer}>
                  ...
                  <Button
                    ...
                    color="violet"
                    radius="xl"
                    onClick={handleSubmitRejectForm}
                  >
                    不通過
                  </Button>
                </div>
