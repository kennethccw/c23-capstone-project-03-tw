...
export function ApplicationContainer(props: { activity: ScheduleActivity; clickHandler: () => void; status?: string }) {
  ...
  return (
    <>
      ...
      <img className={styles.applicationsAppliedImg} src={`${process.env.REACT_APP_S3_UPLOAD_BUCKET_URL}/activities/${props.activity.image}`} alt="" />        <div className={styles.applicationsAppliedTextContent}>
