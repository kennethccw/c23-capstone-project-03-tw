...
var ScheduleService = /** @class */ (function () {
    function ScheduleService(knex) {
        var _this = this;
        this.knex = knex;
        this.getScheduleActivities = function (uid) { return __awaiter(_this, void 0, void 0, function () {
            var confirmedActivities, pendingActivities, e_1;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.knex(tables_1.TABLES.ACTIVITY_APPLICATIONS)
                                .select("*", "organisations.name as organisation", "activities.name as activity", "activity_applications.id as application_id")
