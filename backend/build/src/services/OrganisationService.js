...
var OrganisationService = /** @class */ (function () {
    function OrganisationService(knex) {
        var _this = this;
        this.knex = knex;
        this.getOrganisationList = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.knex(tables_1.TABLES.ORGANISATIONS).select()];
                    case 1:
                        result = _a.sent();
        ...
        this.getOrganisationDetail = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var result, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
