...
exports.uploadMiddlewareForChatroom = void 0;
...
//   "animalNeedHelp"
// );
var uploadDir = path_1.default.join(__dirname, "..", "..", "uploads", "animalNeedHelp");
...
var form = (0, formidable_1.default)({
    ...
    filename: function (originalName, originalExt, part) {
        var _a;
        fileCounter++;
...
var uploadMiddlewareForChatroom = function (req, res, next) {
...
exports.uploadMiddlewareForChatroom = uploadMiddlewareForChatroom;
//# sourceMappingURL=formidableForChatroom.js.map