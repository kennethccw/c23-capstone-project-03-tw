...
exports.uploadMiddlewareForAnimal = void 0;
...
// const uploadDir = path.join(__dirname, "..", "..", "..", "frontend", "public", "photos", "pet");
var uploadDir = path_1.default.join(__dirname, "..", "..", "uploads", "pet");
...
var uploadMiddlewareForAnimal = function (req, res, next) {
...
exports.uploadMiddlewareForAnimal = uploadMiddlewareForAnimal;
//# sourceMappingURL=formidableForAnimal.js.map